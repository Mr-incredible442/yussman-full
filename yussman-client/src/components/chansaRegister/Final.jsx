...
function Final() {
  ...
  const handleDeleteDate = () => {
    apiCall
      .post(`${CHANSA_REGISTER_URL}/${RegisterShift._id}/deletedate`)
      .then(() => {
        check();
      });
  };
  const handleDeleteName = () => {
    apiCall
      .post(`${CHANSA_REGISTER_URL}/${RegisterShift._id}/deletename`)
      .then(() => {
        check();
      });
  };
  const handleDeleteAccountant = () => {
    apiCall
      .post(`${CHANSA_REGISTER_URL}/${RegisterShift._id}/deleteaccountant`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteCash = () => {
    apiCall
      .post(`${CHANSA_REGISTER_URL}/${RegisterShift._id}/deletecash`)
      .then(() => {
        check();
      });
  };
  ...
  const handleDeleteChange = () => {
    apiCall
      .post(`${CHANSA_REGISTER_URL}/${RegisterShift._id}/deletechange`)
      .then(() => {
        check();
      });
  };
